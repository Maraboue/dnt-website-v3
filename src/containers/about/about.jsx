...
const About = () => (
  <div className="dnt__whatdnt section__margin" id="about">
    ...
    <div className="dnt__whatdnt-container">
      <Feature title="Research" text="Behind the idea of a self regulating means of exchange manifested in the DNT token lies a deep dive in computer science. By creating simulations, regression models and more, the token is backed by evidence." />
      <Feature title="Knowledgebased" text="The results from the research conducted, yielded some insights in deflation and self regulation. We managed to reduce both volatility and keep the inflation down by 6,128% over many iterations." />
